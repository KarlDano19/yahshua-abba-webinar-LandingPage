    ...
    <div className="section-inner">
      ...
      <div className="bg-[hsl(0_0%_11%)] rounded-lg p-10 max-[720px]:p-7">
        ...
        <div className="text-[20px] font-semibold text-[rgba(255,255,255,0.9)] mb-3">
          Would your company pass a data privacy check today?
        </div>
        <p className="text-sm text-[rgba(255,255,255,0.45)] leading-[1.75] max-w-[640px] mb-3.5">Companies can now face administrative fines of up to ₱5,000,000 for data privacy violations.

If your organization collects Employee, Payroll, or Customer Data, this applies to you.</p>
